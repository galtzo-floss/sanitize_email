...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/sanitize_email/version.rb", mod) }::SanitizeEmail::Version::VERSION
  else
    require_relative "lib/sanitize_email/version"
    SanitizeEmail::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "sanitize_email"
  spec.version = gem_version
  spec.authors = ["Peter Boling", "John Trupiano", "pboling", "Peter H. Boling", "David Morton", "Harry Lascelles", "Adrien Siami", "Chris Altman", "Scott Rocher", "Marcus Ilgner", "Bernardo Galindo", "joeyparis"]
  ...
  spec.metadata["homepage_uri"] = "https://sanitize-email.galtzo.com"
  ...
  spec.metadata["mailing_list_uri"] = "https://www.rubyforum.org/tag/sanitize-email"
  ...
  spec.add_development_dependency("rspec-pending_for", "~> 0.1", ">= 0.1.24")
end
